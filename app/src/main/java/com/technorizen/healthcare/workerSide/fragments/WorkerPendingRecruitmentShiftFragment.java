...
import com.technorizen.healthcare.databinding.FragmentWorkerPendingRecruitmentShiftBinding;
import com.technorizen.healthcare.fragments.ConfirmRecruitmentFragment;
 ...
 * Use the {@link WorkerPendingRecruitmentShiftFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class WorkerPendingRecruitmentShiftFragment extends Fragment implements RecruitmentShiftConfirmationInterface {

    FragmentWorkerPendingRecruitmentShiftBinding binding;
    ...
    public WorkerPendingRecruitmentShiftFragment() {
     ...
     * @return A new instance of fragment WorkerPendingRecruitmentShiftFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static WorkerPendingRecruitmentShiftFragment newInstance(String param1, String param2) {
        WorkerPendingRecruitmentShiftFragment fragment = new WorkerPendingRecruitmentShiftFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_worker_pending_recruitment_shift, container, false);
            ...
            public void onResponse(Call<SuccessResGetCurrentSchedule> call, Response<SuccessResGetCurrentSchedule> response) {
                ...
                try {
                    ...
                    if (data.status.equals("1")) {
                        ...
                        binding.rvRecruitmentConfirmation.setAdapter(new ConfirmRecruitmentAdapter(getActivity(),confirmRecruitmentList, WorkerPendingRecruitmentShiftFragment.this,false));
