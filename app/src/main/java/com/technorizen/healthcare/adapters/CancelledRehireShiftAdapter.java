 ...
 */
public class CancelledRehireShiftAdapter extends RecyclerView.Adapter<CancelledRehireShiftAdapter.SelectTimeViewHolder> {
    ...
    public CancelledRehireShiftAdapter(Context context, ArrayList<SuccessResGetPost.Result> postedList, boolean from, DeleteShifts shifts)
    {
    ...
    public void onBindViewHolder(@NonNull SelectTimeViewHolder holder, int position) {
        ...
        else
        {
            ...
            tvDistance.setText(context.getString(R.string.distance)+postedList.get(position).getDistance());
        }
...
// representation of a date with the defined format.
      ...
      //  tvNumOfShifts.setText(context.getString(R.string.number_of_shifts_col)+postedList.get(position).getTotalShift());
        ...
        btnReject.setOnClickListener(v ->
                {
                    new AlertDialog.Builder(context)
                            .setTitle("Reject Shift")
                            .setMessage("Are you sure you want to reject shift?")
                            ...
                            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    shifts.rejectSHift(postedList.get(position).getShiftId(),postedList.get(position).getUserId(),postedList.get(position).getPostshiftTime(),postedList.get(position).getType());
                    ...
                    new AlertDialog.Builder(context)
                            ...
                            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    try {
                                        shifts.onClick(postedList.get(position).getShiftId(),postedList.get(position).getUserId(),postedList.get(position).getPostshiftTime(),postedList.get(position).getType());
                                    } catch (ParseException e) {
                                        e.printStackTrace();
                                    }
