 ...
 */
public class HomeFragment extends Fragment implements DeleteShifts {
            ...
            public void onResponse(Call<SuccessResGetPost> call, Response<SuccessResGetPost> response) {
                ...
                try {
                    ...
                    if (data.status.equals("1")) {
                        ...
                        binding.rvShifts.setAdapter(new ShiftsAdapter(getActivity(),postedList,true,HomeFragment.this::onClick));
