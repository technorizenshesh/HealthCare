...
import com.shifts.healthcare.adapters.CardAdapter;
import com.shifts.healthcare.databinding.FragmentAddCreditCardBinding;
...
import com.shifts.healthcare.util.CardInterface;
...
//    }
    ...
    public void makePayment()
    {
        ...
        Call<ResponseBody> call = apiInterface.makePayment(map);
        call.enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
