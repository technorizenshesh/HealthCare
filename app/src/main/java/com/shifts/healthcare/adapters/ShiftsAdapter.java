                            ...
                            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    try {
                                        ...
                                        if(postedList.get(position).getWorkerIs().equalsIgnoreCase("Unapproved"))
                                        {
                                            shifts.onClick("Unapproved",postedList.get(position).getUserId(),postedList.get(position).getPostshiftTime(),postedList.get(position).getType());
